...
$sourceUrl = function_exists('route') ? route('surveillance.report.fitness') : 'surveillance_fitnessReport.php';
...
<div class="pdf-page">
    <section class="page-head">
        <h2>PDF USECHH 3</h2>
        <p>Preview the USECHH 3 certificate of fitness page before printing.</p>
    </section>
    ...
    <section class="preview-shell">
        <div class="preview-meta">
            <div class="meta-box">
                <span>PDF Group</span>
                <strong>USECHH 3</strong>
            </div>
            <div class="meta-box">
                <span>Preview Source</span>
                <strong>USECHH 3 Fitness Report</strong>
            </div>
            <div class="meta-box">
                <span>Mode</span>
        ...
        <section class="preview-frame-card">
            ...
            <iframe class="preview-iframe" name="pdfPreviewFrame" src="<?php echo $esc($sourceUrl); ?>" title="PDF USECHH 3 preview"></iframe>
