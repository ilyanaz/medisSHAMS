...
$addRecordUrl = function_exists('route') ? route('surveillance.record.start', ['company_id' => $selectedCompany->company_id ?? '', 'employee_id' => $selectedEmployee->employee_id ?? '']) : '#';
$nextUrl = '#';
$steps = [
    ['label' => 'Company'],
    ['label' => 'Employee'],
    ['label' => 'Surveillance List', 'active' => true],
    ['label' => 'Declaration'],
    ['label' => 'Examination'],
    ['label' => 'Report'],
];
