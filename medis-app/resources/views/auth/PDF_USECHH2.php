...
$sourceUrl = function_exists('route') ? route('surveillance.report.summary-employee', request()->only(['declaration_id','employee_id','company_id','surveillance_id'])) : 'surveillance_summaryEmpReport.php';
