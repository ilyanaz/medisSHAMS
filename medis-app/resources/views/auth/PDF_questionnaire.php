...
<div class="pdf-page">
    <section class="page-head">
        <h2>PDF Questionnaire</h2>
        <p>Preview the audiometry questionnaire page in a print-friendly PDF wrapper.</p>
    </section>
    ...
    <section class="preview-shell">
        <div class="preview-meta">
            <div class="meta-box">
                <span>PDF Group</span>
                <strong>Audiometry Questionnaire</strong>
            </div>
            <div class="meta-box">
        ...
        <section class="preview-frame-card">
            ...
            <iframe class="preview-iframe" name="pdfPreviewFrame" src="<?php echo $esc($sourceUrl); ?>" title="PDF Questionnaire preview"></iframe>
