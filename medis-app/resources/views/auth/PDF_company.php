...
$sourceUrl = function_exists('route') ? route('surveillance.company') : 'surveillance_company.php';
...
<div class="pdf-page">
    <section class="page-head">
        <h2>PDF Company</h2>
        <p>Preview the company record page in a print-friendly PDF wrapper.</p>
    </section>
    ...
    <section class="preview-shell">
        <div class="preview-meta">
            ...
            <div class="meta-box">
                ...
                <strong>Surveillance Company</strong>
            </div>
            <div class="meta-box">
                <span>Mode</span>
        ...
        <section class="preview-frame-card">
            ...
            <iframe class="preview-iframe" name="pdfPreviewFrame" src="<?php echo $esc($sourceUrl); ?>" title="PDF Company preview"></iframe>
