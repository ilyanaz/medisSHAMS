...
$sourceUrl = function_exists('route') ? route('surveillance.report.removal') : 'surveillance_removalReport.php';
...
<div class="pdf-page">
    <section class="page-head">
        <h2>PDF USECHH 5i</h2>
        <p>Preview the USECHH 5i medical removal protection page before printing.</p>
    </section>
    ...
    <section class="preview-shell">
        <div class="preview-meta">
            <div class="meta-box">
                <span>PDF Group</span>
                <strong>USECHH 5i</strong>
            </div>
            <div class="meta-box">
                <span>Preview Source</span>
                <strong>USECHH 5i Removal Report</strong>
            </div>
            <div class="meta-box">
                <span>Mode</span>
