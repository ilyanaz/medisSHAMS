...
$sourceUrl = function_exists('route') ? route('audiometry.report') : 'audiometry_report.php';
...
<div class="pdf-page">
    <section class="page-head">
        <h2>PDF Audio Report</h2>
        <p>Preview the audiometry report page in a print-friendly PDF wrapper.</p>
    </section>
    ...
    <section class="preview-shell">
        <div class="preview-meta">
            <div class="meta-box">
                <span>PDF Group</span>
                <strong>Audiometry Report</strong>
            </div>
            <div class="meta-box">
