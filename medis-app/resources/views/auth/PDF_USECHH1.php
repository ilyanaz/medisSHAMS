...
$sourceUrl = function_exists('route') ? route('surveillance.report.usechh1', ['employee_id' => request()->query('employee_id')]) : 'surveillance_usechh1Report.php';
...
<div class="pdf-page">
    <section class="page-head">
        <h2>PDF USECHH 1</h2>
        <p>Preview the USECHH 1 employee record page before printing.</p>
    </section>
    ...
    <section class="preview-shell">
        <div class="preview-meta">
            ...
            <div class="meta-box">
                ...
                <strong>USECHH 1 / Employee Record</strong>
            </div>
            <div class="meta-box">
                <span>Mode</span>
